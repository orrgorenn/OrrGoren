...
const Skills: React.FC = () => {
  ...
  return (
    <div ref={refContainer} className="bg-black text-white">
      <div className="min-h-screen max-w-5xl mx-auto px-10 lg:px-20 py-24 md:py-28 lg:py-36 flex flex-col items-center text-4xl md:text-5xl lg:text-6xl tracking-tight font-semibold">
